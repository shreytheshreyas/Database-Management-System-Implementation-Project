...
public class HashJoinPlan implements Plan {
     ...
     */
    public HashJoinPlan(Transaction tx, Plan p1, Plan p2, String fldname1, String fldname2, boolean isDistinct) {
        this.tx = tx;
        this.p1 = p1;
        this.p2 = p2;
        this.fldname1 = fldname1;
        this.fldname2 = fldname2;
        //make a distinct variable and initialise it later
        // initialize members of HashJoinPlan
    }
    ...
    public Scan open() {
        Scan s1 = p1.open();
        Scan s2 = p2.open();
        //need to think of algo and return a hashJoinScan
        return new HashJoinScan(s1, s2, fldname1, fldname2, tx.availableBuffs(), p1);
    }
     ...
     */
    //Cost for HashMergeJoin = 3 * (no._of_pages_in_table_1 + no._of_pages_in_table_2)
