...
//   MY IMPLEMENTATION
   ...
   public Term(Expression lhs, Expression rhs) {
      this.lhs = lhs;
      this.rhs = rhs;
      this.relationalOp = "="; // MY IMPLEMENTATION
   }

//   MY IMPLEMENTATION
   public Term(Expression lhs, Expression rhs, String relationalOp) {
      this.lhs = lhs;
      this.rhs = rhs;
      this.relationalOp = relationalOp;
   }

   //Important for the comparison operation
   /**
...
//      return rhsval.equals(lhsval);
   ...
   //TODO: CHANGE THIS FORMAT TO lessWithField
//   public String equatesWithField(String fldname) {
//      if (lhs.isFieldName() &&
//              lhs.asFieldName().equals(fldname) &&
//              rhs.isFieldName())
...
//   }
   ...
   //TODO: CHANGE THE FORMAT TO lessEqualWithField
//   public String equatesWithField(String fldname) {
//      if (lhs.isFieldName() &&
//              lhs.asFieldName().equals(fldname) &&
//              rhs.isFieldName())
...
//   }
   ...
   //TODO: CHANGE THE FORMAT TO greaterWithField
//   public String equatesWithField(String fldname) {
//      if (lhs.isFieldName() &&
//              lhs.asFieldName().equals(fldname) &&
//              rhs.isFieldName())
...
//   }
   ...
   //TODO: CHANGE THE FORMAT TO greaterEqualWithField
//   public String equatesWithField(String fldname) {
//      if (lhs.isFieldName() &&
//              lhs.asFieldName().equals(fldname) &&
//              rhs.isFieldName())
...
//   }
   ...
   //TODO: CHANGE THE FORMAT TO notEqualToWithField
//   public String equatesWithField(String fldname) {
//      if (lhs.isFieldName() &&
//              lhs.asFieldName().equals(fldname) &&
//              rhs.isFieldName())
